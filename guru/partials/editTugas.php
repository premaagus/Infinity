...
<?php 
	...
	$data_tugas 	= $queryTugas->fetch_assoc();

	$id_mapel = $data_tugas['id_mapel'];
	...
	//mulai
	$tugas_mulai = explode(' ', $data_tugas['tugas_mulai']);
	$mulaiDate = $tugas_mulai[0];
	$mulaiHour = $tugas_mulai[1];
	$tugas_mulai = $mulaiDate.'T'.$mulaiHour;
	//selesai
	$tugas_selesai = explode(' ', $data_tugas['tugas_selesai']);
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<div class="container1 d-flex f-row">
		...
		<div class="form-control-block">
			<p>Judul Tugas</p>
			<input type="text" name="nama_tugas" id="nama_tugas" placeholder="Input Judul Tugas Disini..." required value="<?php echo $data_tugas['nama_tugas'] ?>">
			<div class="alert-err">
		...
		<div class="form-control-block">
			<p>Deskripsi Tugas</p>
			<textarea name="desc_tugas" id="desc_tugas" placeholder="Input Deskripsi Tugas Disini..." required><?php echo $data_tugas['desc_tugas'] ?></textarea>
			<div class="alert-err">
		...
		<div class="form-control-block">
			<p>File Tugas</p>
			<span><?php echo $data_tugas['file_tugas'] ?></span>
			<input type="file" name="file_tugas" id="file_tugas" placeholder="Input File Tugas Disini...">
			<div class="alert-err">
		...
		<div class="form-control">
			<p>Mulai</p>
			<input type="datetime-local" name="tugas_mulai" id="tugas_mulai" placeholder="Input File Materi Disini..." required value="<?php echo $tugas_mulai ?>">
			<div class="alert-err">
		...
		<div class="form-control">
			<p>Selesai</p>
			<input type="datetime-local" name="tugas_selesai" id="tugas_selesai" placeholder="Input File Materi Disini..." required value="<?php echo $tugas_selesai ?>">
			<div class="alert-err">
...
<?php 
	if (isset($_POST['btn-submit'])) {
		...
		if ($_FILES['file_tugas']['error'] == 4) {
			$namaBaru = $data_tugas['file_tugas'];
		}
		else{
			upload();
			$namaBaru = upload();
		...
		if ($tugas_selesai < $tugas_selesai) {
			...
			$queryAdd = $koneksi->query("UPDATE tb_tugas SET nama_tugas = '$nama_tugas', desc_tugas = '$desc_tugas', tugas_mulai = '$tugas_mulai', tugas_selesai = '$tugas_selesai', file_tugas = '$namaBaru' WHERE id_tugas = $id_tugas ");
			if ($queryAdd) {
				?>
				<script>
					successAlert("Sukses", "Tugas Telah diubah!");
					document.addEventListener('click', function(){
				...
				?>
				<script>
					errorAlert("Error", "Tugas gagal diubah!");
				</script>
				<?php
			}
		}
